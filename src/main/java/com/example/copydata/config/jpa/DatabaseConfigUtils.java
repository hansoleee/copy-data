...
public class DatabaseConfigUtils {
    ...
    public static final String BASE_PACKAGE = "com.example.copydata";
    ...
    public static LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(String persistenceUnitName,
        ...
        emf.setPackagesToScan(BASE_PACKAGE + DOMAIN_PACKAGE);
